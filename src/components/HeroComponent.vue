<template>
  <main class="flex-auto">
    ...
    <div class="mx-auto max-w-7xl px-4 mt-28 relative">
      <div class="mx-auto max-w-2xl justify-start text-left">
        <h1 class="font-display text-6xl font-bold text-blue-600">
          A design conference for the dark side.
        </h1>
        <div class="mt-6 space-y-6 font-display text-2xl text-blue-900">
          <p>
        ...
        <dl
          class="mt-16 grid grid-cols-1 gap-x-10 gap-y-6 grid-flow-col justify-start text-left"
        >
          <div>
            <dt class="font-mono text-sm text-blue-600">Speakers</dt>
            <dd class="mt-0.5 text-2xl font-semibold text-blue-900">18</dd>
          </div>
          <div>
            <dt class="font-mono text-sm text-blue-600">People Attending</dt>
            <dd class="mt-0.5 text-2xl font-semibold text-blue-900">2,091</dd>
          </div>
          <div>
            <dt class="font-mono text-sm text-blue-600">Venue</dt>
            <dd class="mt-0.5 text-2xl font-semibold text-blue-900">
              Staples Center
            </dd>
          </div>
          <div>
    ...
    <div class="mx-8 max-w-2xl mt-40 justify-start text-left">
      <h2 class="font-display text-5xl font-medium text-blue-600">Speakers</h2>
      <p class="mt-4 font-display text-2xl text-blue-900">
    ...
    <div class="flex justify-between mt-32">
      <div class="flex flex-col items-start h-auto text-left ml-3">
    ...
    <div class="justify-start text-left max-w-7xl px-8 relative mt-40">
      <div class="mx-0 max-w-4xl pr-24">
        <h2 class="font-display text-4xl font-bold text-blue-600">
    ...
    <div class="mt-36">
      <div class="grid grid-cols-3 gap-x-8">
        <div>
          <h3 class="text-left ml-7 text-2xl font-semibold text-blue-900">
            April 4
          </h3>
          <p class="text-left ml-7 text-blue-900">
          ...
          >
            <li>
              <h4 class="text-lg font-semibold text-blue-900">Steven McHail</h4>
              <p class="mt-1 text-blue-900">Not so one-time payments</p>
            ...
            <li>
              ...
              <h4 class="text-lg font-semibold text-blue-900">Jaquelin Isch</h4>
              <p class="mt-1 text-blue-900">The finer print</p>
              <p class="mt-1 font-mono text-sm text-slate-500">
                10:00AM - 11:00AM PST
              </p>
            </li>
            <li>
              ...
              <p class="mt-1 text-blue-900">Post-purchase blackmail</p>
              <p class="mt-1 font-mono text-sm text-slate-500">
                11:00AM - 12:00PM PST
              </p>
            </li>
            <li>
              <div class="mx-auto mb-8 h-px w-48 bg-indigo-500/10"></div>
              <h4 class="text-lg font-semibold text-blue-900">Lunch</h4>
              <p class="mt-1 font-mono text-sm text-slate-500">
                12:00PM - 1:00PM PST
              </p>
            </li>
            <li>
              ...
              <p class="mt-1 text-blue-900">Buy or die</p>
              <p class="mt-1 font-mono text-sm text-slate-500">
                1:00PM - 2:00PM PST
              </p>
            </li>
            <li>
              ...
              <p class="mt-1 text-blue-900">In-person cancellation</p>
              <p class="mt-1 font-mono text-sm text-slate-500">
                2:00PM - 3:00PM PST
              </p>
            </li>
            <li>
              ...
              <p class="mt-1 text-blue-900">The pay/cancel switcheroo</p>
              <p class="mt-1 font-mono text-sm text-slate-500">
                3:00PM - 4:00PM PST
              </p>
            </li>
        ...
        <div>
          ...
          >
            <li>
              ...
              <p class="mt-1 text-blue-900">The invisible card reader</p>
              <p class="mt-1 font-mono text-sm text-slate-500">
                9:00AM - 10:00AM PST
              </p>
            </li>
            <li>
              ...
              <p class="mt-1 text-blue-900">Stealing fingerprints</p>
              <p class="mt-1 font-mono text-sm text-slate-500">
                10:00AM - 11:00AM PST
              </p>
            </li>
            <li>
              ...
              <p class="mt-1 text-blue-900">Voting machines</p>
              <p class="mt-1 font-mono text-sm text-slate-500">
                11:00AM - 12:00PM PST
              </p>
            </li>
            ...
            <li>
              ...
              <p class="mt-1 text-blue-900">Blackhat SEO that works</p>
              <p class="mt-1 font-mono text-sm text-slate-500">
                1:00PM - 2:00PM PST
              </p>
            </li>
            <li>
              <div class="mx-auto mb-8 h-px w-48 bg-indigo-500/10"></div>
              <h4 class="text-lg font-semibold text-blue-900">Waylon Hyden</h4>
            ...
            <li>
              ...
              <p class="mt-1 text-blue-900">Fly phishing</p>
              <p class="mt-1 font-mono text-sm text-slate-500">
                3:00PM - 4:00PM PST
              </p>
            </li>
        ...
        <div>
          ...
          <p class="text-left ml-7 mt-1.5 text-base text-blue-900">
          ...
          >
            <li>
              <h4 class="text-lg font-semibold text-blue-900">Andrew Greene</h4>
              <p class="mt-1 text-blue-900">Neuralink dark patterns</p>
              <p class="mt-1 font-mono text-sm text-slate-500">
                9:00AM - 10:00AM PST
              </p>
            </li>
            <li>
              <div class="mx-auto mb-8 h-px w-48 bg-indigo-500/10"></div>
              <h4 class="text-lg font-semibold text-blue-900">Heather Terry</h4>
              <p class="mt-1 text-blue-900">DALL-E for passports</p>
              <p class="mt-1 font-mono text-sm text-slate-500">
                10:00AM - 11:00AM PST
              </p>
            </li>
            <li>
              <div class="mx-auto mb-8 h-px w-48 bg-indigo-500/10"></div>
              <h4 class="text-lg font-semibold text-blue-900">Piers Wilkins</h4>
              <p class="mt-1 text-blue-900">Quantum password cracking</p>
              <p class="mt-1 font-mono text-sm text-slate-500">
                11:00AM - 12:00PM PST
              </p>
            </li>
            ...
            <li>
              ...
              <p class="mt-1 text-blue-900">SkyNet is coming</p>
              <p class="mt-1 font-mono text-sm text-slate-500">
                1:00PM - 2:00PM PST
              </p>
            </li>
            <li>
              ...
              <p class="mt-1 text-blue-900">Dark patterns for the metaverse</p>
              <p class="mt-1 font-mono text-sm text-slate-500">
                2:00PM - 3:00PM PST
              </p>
            </li>
            <li>
              ...
              <p class="mt-1 text-blue-900">Knowing the game and playing it</p>
              <p class="mt-1 font-mono text-sm text-slate-500">
                3:00PM - 4:00PM PST
              </p>
            </li>
    ...
    <div class="mt-48">
      <div>
        <h2
          class="mx-auto max-w-2xl text-center font-display text-5xl font-medium text-blue-900"
        >
          Current sponsorships for our workshops and speakers.
        </h2>
      </div>
      <div class="mx-auto mt-20 grid max-w-max gap-x-32 gap-y-12 grid-cols-3">
        <div
    ...
    <div class="mt-28 mb-28">
      <div class="mx-auto max-w-7xl px-8">
        <div class="relative bg-indigo-50 py-20 rounded-3xl px-16">
          <div
            class="relative mx-auto grid gap-x-32 gap-y-14 max-w-none grid-cols-2"
          >
            <div class="text-left">
              <p class="font-display text-5xl font-medium text-blue-900">
                Stay up to date
              </p>
            ...
            <form>
              <h3 class="text-left text-lg font-semibold text-blue-900">
                Sign up to our newsletter ↓
              </h3>
              <div
                class="mt-5 flex rounded-3xl bg-white py-2.5 pr-2.5 shadow-xl shadow-blue-900/5"
              >
                <input
                  type="email"
                  required=""
                  placeholder="Email address"
                  class="flex-auto bg-transparent pl-6 pr-2.5 text-base text-slate-900 placeholder:text-slate-400"
                />
                <button
                  class="inline-flex justify-center rounded-2xl bg-blue-600 p-4 text-base font-semibold text-white hover:bg-blue-500"
                >
                  <span class="not-sr-only">Sign up today</span>
                </button>
              </div>
            </form>
          </div>
